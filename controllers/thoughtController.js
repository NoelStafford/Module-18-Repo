...
const thoughtController = {
  ...
  getThoughts(req, res) {
    Thought.find()
      .then((thoughts) => res.json(applications))
  ...
  // Because thoughts are associated with Users, we then update the User who created the thoguht and add the ID of the thought to the thoughts array
